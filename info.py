...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://thaneswarmalik9:JANU@2000@tm-filter-bot-db.toaitpn.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "TM-FILTER-BOT-DB")
